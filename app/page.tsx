          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-12 items-start">
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-3 py-1 border border-stone-800 bg-stone-900/50" style={{ borderColor: `color-mix(in srgb, var(--tint), transparent 86%)` }}>
                ...
                <h1 className="text-4xl md:text-7xl font-bold tracking-tighter leading-[1.1] mix-blend-exclusion" style={{ color: `var(--tint)`, textShadow: `0 0 20px var(--tint)` }}>
                  {/* @ts-ignore */}
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <a href="/about"
                  ...
                  style={{ 
                    borderColor: `color-mix(in srgb, var(--tint), transparent 73%)`,
                    color: `var(--tint)` 
                  }}
                >
                  Get In Touch
            ...
            <div className="w-full md:w-80 space-y-4">
              <div 
                ...
                style={{ borderColor: `color-mix(in srgb, var(--tint), transparent 87%)` }}
              >
                {/* Header */}
        ...
        <div className="w-full max-w-5xl px-4">
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
            <div className="cursor-target space-y-6 flex-row justify-items-center">
              ...
              <div className="space-y-4">
                ...
                <h2 className="cursor-target text-4xl md:text-6xl font-bold text-white tracking-tighter hover:bg-black/30 hover:backdrop-blur-sm duration-400">
                  Who is <span style={{ color: `color-mix(in srgb, var(--tint), transparent 7%)`, textShadow: `0 0 20px var(--tint)` }}>Alan</span>?
                </h2>
              </div>
            </div>
            ...
            <div 
              ...
              style={{ borderColor: `color-mix(in srgb, var(--tint), transparent 80%)` }}
            >
               <div 
              ...
              <div className="space-y-6">
                 <p 
                  ...
                  style={{ 
                    color: `var(--tint)`,
                    textShadow: `0 0 10px color-mix(in srgb, var(--tint), transparent 73%)`
                  }}
                >
